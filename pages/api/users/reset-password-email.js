...
async function handlePost(req, res) {
  ...
  const mailBody = `Rendez-vous sur ce lien pour changer votre mot de passe : ${process.env.NEXTAUTH_URL}/mot-de-passe-oublie?resetPasswordToken=${resetPasswordToken}&email=${email}`;
